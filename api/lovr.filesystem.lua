...
---@see lovr.filesystem
---@overload fun(filename: string, blob: Blob): number
---@param filename string # The file to append to.
---@param content string # A string to write to the end of the file.
---@return number # The number of bytes actually appended to the file.
...
---@see lovr.filesystem
---@return string # The absolute path to the appdata directory.
...
---@return table # A table with a string for each file and subfolder in the directory.
function filesystem.getDirectoryItems(path) end

--- Returns the absolute path of the LÖVR executable.
---@see lovr.filesystem
---@return string # The absolute path of the LÖVR executable, or `nil` if it is unknown.
...
---@see lovr.filesystem.setIdentity
---@see lovr.filesystem
---@return string # The name of the save directory, or `nil` if it isn't set.
...
---@return number # The modification time of the file, in seconds, or `nil` if it's unknown.
...
---@return string # The absolute path of the mounted archive containing `path`.
...
---@see lovr.filesystem.setRequirePath
---@see lovr.filesystem
...
---@see lovr.filesystem
---@return string # The absolute path of the project's source, or `nil` if it's unknown.
function filesystem.getSource() end

--- Returns the absolute path of the user's home directory.
---@see lovr.filesystem
---@return string # The absolute path of the user's home directory.
...
---@see lovr.filesystem
---@return string # The current working directory, or `nil` if it's unknown.
...
---@param bytes number? # The number of bytes to read (if -1, all bytes will be read). (default: -1)
---@return string # The contents of the file.
---@return number # The number of bytes read from the file.
function filesystem.read(filename, bytes) end
...
---@see lovr.filesystem.getRequirePath
---@see lovr.filesystem
...
---@see lovr.filesystem.read
---@see lovr.filesystem
---@overload fun(filename: string, blob: Blob): boolean
