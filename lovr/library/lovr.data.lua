...
---
--- [Open in browser](https://lovr.org/docs/Blob)
---@class Blob
local Blob = {}

--- Returns the size of the Blob's contents, in bytes.
---
--- [Open in browser](https://lovr.org/docs/Blob:getSize)
...
---
--- [Open in browser](https://lovr.org/docs/Blob:getName)
...
---
--- [Open in browser](https://lovr.org/docs/Blob:getI8)
---@see Blob.setI8
---@see Blob.getU8
---@see Blob.getI16
---@see Blob.getU16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:getU8)
---@see Blob.setU8
---@see Blob.getI8
---@see Blob.getI16
---@see Blob.getU16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:getI16)
---@see Blob.setI16
---@see Blob.getI8
---@see Blob.getU8
---@see Blob.getU16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:getU16)
---@see Blob.setU16
---@see Blob.getI8
---@see Blob.getU8
---@see Blob.getI16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:getI32)
---@see Blob.setI32
---@see Blob.getI8
---@see Blob.getU8
---@see Blob.getI16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:getU32)
---@see Blob.setU32
---@see Blob.getI8
---@see Blob.getU8
---@see Blob.getI16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:getF32)
---@see Blob.setF32
---@see Blob.getI8
---@see Blob.getU8
---@see Blob.getI16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:getF64)
---@see Blob.setF64
---@see Blob.getI8
---@see Blob.getU8
---@see Blob.getI16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:setI8)
---@see Blob.getI8
---@see Blob.setU8
---@see Blob.setI16
---@see Blob.setU16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:setU8)
---@see Blob.getU8
---@see Blob.setI8
---@see Blob.setI16
---@see Blob.setU16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:setI16)
---@see Blob.getI16
---@see Blob.setI8
---@see Blob.setU8
---@see Blob.setU16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:setU16)
---@see Blob.getU16
---@see Blob.setI8
---@see Blob.setU8
---@see Blob.setI16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:setI32)
---@see Blob.getI32
---@see Blob.setI8
---@see Blob.setU8
---@see Blob.setI16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:setU32)
---@see Blob.getU32
---@see Blob.setI8
---@see Blob.setU8
---@see Blob.setI16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:setF32)
---@see Blob.getF32
---@see Blob.setI8
---@see Blob.setU8
---@see Blob.setI16
...
---
--- [Open in browser](https://lovr.org/docs/Blob:setF64)
---@see Blob.getF64
---@see Blob.setI8
---@see Blob.setU8
---@see Blob.setI16
...
---
--- [Open in browser](https://lovr.org/docs/Image)
---@class Image
local Image = {}

--- Encodes the Image to an **uncompressed** png.  This intended mainly for debugging.
---
--- [Open in browser](https://lovr.org/docs/Image:encode)
...
---
--- [Open in browser](https://lovr.org/docs/Image:getBlob)
---@see Blob.getPointer
---@see Sound.getBlob
...
---
--- [Open in browser](https://lovr.org/docs/Image:getDimensions)
---@see Image.getWidth
---@see Image.getHeight
...
---
--- [Open in browser](https://lovr.org/docs/Image:getFormat)
---@see TextureFormat
...
---
--- [Open in browser](https://lovr.org/docs/Image:getHeight)
---@see Image.getWidth
...
---
--- [Open in browser](https://lovr.org/docs/Image:getPixel)
---@see Image.setPixel
---@see Image.mapPixel
---@see TextureFormat
...
---
--- [Open in browser](https://lovr.org/docs/Image:getPointer)
...
---
--- [Open in browser](https://lovr.org/docs/Image:getWidth)
---@see Image.getHeight
---@see Image.getDimensions
...
---
--- [Open in browser](https://lovr.org/docs/Image:mapPixel)
---@see Image.setPixel
---@see Image.getPixel
---@see TextureFormat
---@see Texture.setPixels
...
---
--- [Open in browser](https://lovr.org/docs/Image:paste)
---@see Image.getPixel
---@see Image.setPixel
---@see Texture.setPixels
...
---
--- [Open in browser](https://lovr.org/docs/Image:setPixel)
---@see Image.mapPixel
---@see Image.getPixel
---@see TextureFormat
---@see Texture.setPixels
...
---
--- [Open in browser](https://lovr.org/docs/ModelData)
---@class ModelData
local ModelData = {}
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getAnimationChannelCount)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getAnimationCount)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getAnimationDuration)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getAnimationKeyframe)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getAnimationKeyframeCount)
---@see ModelData.getAnimationSmoothMode
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getAnimationName)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getAnimationNode)
---@see ModelData.getAnimationProperty
---@see ModelData.getAnimationSmoothMode
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getAnimationProperty)
---@see ModelData.getAnimationNode
---@see ModelData.getAnimationSmoothMode
---@param animation string | number # The name or index of an animation.
---@param channel number # The index of a channel in the animation.
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getAnimationSmoothMode)
---@see ModelData.getAnimationNode
---@see ModelData.getAnimationProperty
---@param animation string | number # The name or index of an animation.
---@param channel number # The index of a channel in the animation.
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getBlendShapeCount)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getBlendShapeName)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getBlob)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getBlobCount)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getBoundingBox)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getBoundingSphere)
---@see ModelData.getWidth
---@see ModelData.getHeight
---@see ModelData.getDepth
---@see ModelData.getDimensions
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getCenter)
---@see ModelData.getWidth
---@see ModelData.getHeight
---@see ModelData.getDepth
---@see ModelData.getDimensions
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getDepth)
---@see ModelData.getWidth
---@see ModelData.getHeight
---@see ModelData.getDimensions
---@see ModelData.getCenter
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getDimensions)
---@see ModelData.getWidth
---@see ModelData.getHeight
---@see ModelData.getDepth
---@see ModelData.getCenter
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getHeight)
---@see ModelData.getWidth
---@see ModelData.getDepth
---@see ModelData.getDimensions
---@see ModelData.getCenter
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getImage)
---@see ModelData.getImageCount
---@see ModelData.getBlob
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getImageCount)
---@see ModelData.getImage
---@see ModelData.getBlobCount
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMaterial)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMaterialCount)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMaterialName)
---@see ModelData.getMaterialCount
---@see ModelData.getMeshMaterial
---@see ModelData.getMaterial
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMeshCount)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMeshDrawMode)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMeshIndex)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMeshIndexCount)
---@param mesh number # The index of a mesh.
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMeshIndexFormat)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMeshMaterial)
---@param mesh number # The index of a mesh.
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMeshVertex)
---@see ModelData.getMeshVertexFormat
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMeshVertexCount)
---@see ModelData.getMeshIndexCount
---@param mesh number # The index of a mesh.
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMeshVertexFormat)
---@see ModelData.getMeshIndexFormat
---@param mesh number # The index of a mesh.
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getMetadata)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodeChildren)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodeCount)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodeMeshes)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodeName)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodeOrientation)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodeParent)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodePose)
---@see ModelData.getNodePosition
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodePosition)
---@see ModelData.getNodeOrientation
---@see ModelData.getNodeScale
---@see ModelData.getNodePose
---@see ModelData.getNodeTransform
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodeScale)
---@see ModelData.getNodePosition
---@see ModelData.getNodeOrientation
---@see ModelData.getNodePose
---@see ModelData.getNodeTransform
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodeSkin)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getNodeTransform)
---@see ModelData.getNodePosition
---@see ModelData.getNodeOrientation
---@see ModelData.getNodeScale
---@see ModelData.getNodePose
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getRootNode)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getSkinCount)
---@see Model.hasJoints
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getSkinInverseBindMatrix)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getSkinJoints)
---@param skin number # The index of a skin.
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getTriangleCount)
---@see ModelData.getTriangles
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getTriangles)
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getVertexCount)
---@see ModelData.getTriangles
---@see ModelData.getTriangleCount
...
---
--- [Open in browser](https://lovr.org/docs/ModelData:getWidth)
---@see ModelData.getHeight
---@see ModelData.getDepth
---@see ModelData.getDimensions
---@see ModelData.getCenter
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer)
---@class Rasterizer
local Rasterizer = {}
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getAdvance)
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getAscent)
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getBearing)
---@param glyph string | number # A character or codepoint.
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getBoundingBox)
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getCurves)
---@see Curve
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getDescent)
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getDimensions)
---@see Rasterizer.getWidth
---@see Rasterizer.getHeight
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getFontSize)
---@see Rasterizer.getHeight
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getGlyphCount)
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getHeight)
---@see Rasterizer.getWidth
---@see Rasterizer.getDimensions
---@see Rasterizer.getBoundingBox
---@param glyph string | number # A character or codepoint.
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getKerning)
---@see Font.getKerning
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getLeading)
---@see Rasterizer.getAscent
---@see Rasterizer.getDescent
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:getWidth)
---@see Rasterizer.getHeight
---@see Rasterizer.getDimensions
---@see Rasterizer.getBoundingBox
---@param glyph string | number # A character or codepoint.
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:hasGlyphs)
...
---
--- [Open in browser](https://lovr.org/docs/Rasterizer:newImage)
...
---
--- [Open in browser](https://lovr.org/docs/Sound)
---@class Sound
local Sound = {}

--- Returns a Blob containing the raw bytes of the Sound.
---
--- [Open in browser](https://lovr.org/docs/Sound:getBlob)
---@see Blob.getPointer
---@see Image.getBlob
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getByteStride)
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getCapacity)
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getChannelCount)
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getChannelLayout)
---@see Sound.getChannelCount
---@see Sound.getByteStride
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getDuration)
---@see Sound.getFrameCount
---@see Sound.getSampleCount
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getFormat)
---@see Sound.getChannelLayout
---@see Sound.getByteStride
---@see Sound.getSampleRate
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getFrameCount)
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getFrames)
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getSampleCount)
---@see Sound.getDuration
---@see Sound.getFrameCount
---@see Sound.getChannelCount
...
---
--- [Open in browser](https://lovr.org/docs/Sound:getSampleRate)
...
---
--- [Open in browser](https://lovr.org/docs/Sound:isCompressed)
---@see Sound.isStream
...
---
--- [Open in browser](https://lovr.org/docs/Sound:isStream)
...
---
--- [Open in browser](https://lovr.org/docs/Sound:setFrames)
...
--- Creates a new Blob.
---
--- [Open in browser](https://lovr.org/docs/lovr.data.newBlob)
...
---
--- [Open in browser](https://lovr.org/docs/lovr.data.newImage)
...
---
--- [Open in browser](https://lovr.org/docs/lovr.data.newRasterizer)
...
---
--- [Open in browser](https://lovr.org/docs/lovr.data.newSound)
